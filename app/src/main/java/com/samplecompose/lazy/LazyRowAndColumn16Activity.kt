    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            SampleComposeTheme {
                ...
                MyApp(modifier = Modifier, languages)
            }
        }
    }
}
    ...
    Column(modifier = modifier.fillMaxSize()) {
        LazyRow {
            items(items = languages) { language ->
                RowItem(modifier, language)
            }
        }
        LazyColumn {
            items(items = languages) { language ->
                ColumnItem(modifier, language)
            }
        }
    }
}
...
@Composable
fun ColumnItem(modifier: Modifier, item: String) {
    Card(
        modifier
            .padding(10.dp)
            .fillMaxWidth()
...
@Composable
fun RowItem(modifier: Modifier = Modifier, item: String) {
    Card(
        modifier
            .padding(10.dp)
            .fillMaxWidth()
